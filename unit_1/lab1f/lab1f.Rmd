...
- <span class="blue">Look at the variables you thought should be _numeric_ and select one. Then fill in the blanks below to see how we can correctly code it as a number:</span>
```{r, eval = FALSE, echo = TRUE}
...
- <span class="blue">First `Import` your `food` data onto the *Environment* pane.</span>
