...
Now that we have which observations to sample, and again we want there to be some duplicated observations, we’ll use `slice()` to use these rows to create a new set of data.
```{r, echo = TRUE, eval = FALSE}
