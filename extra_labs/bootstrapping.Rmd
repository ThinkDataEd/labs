...
Now that we have which observations to sample, and again we want there to be some duplicated observations, we’ll use _slice()_ to use these rows to create a new set of data.
```{r, echo = TRUE, eval = FALSE}
...
You now have a 90% confidence interval!
...
Now, we can add them together and divide by two.
```{r, echo = TRUE, eval = FALSE}
