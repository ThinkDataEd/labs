...
- **(10) Write and run code creating a `treeplot` for this model and answer the following questions:**
    - **(11) Mrs. Cumings was a 38-year-old female with a 1st class ticket from Cherbourg. Does the model predict that she survived?**
...
- **(22) A _regression tree_ is a tree model that predicts a numerical variable. Write and run code creating a _regression tree_ model to predict the Titanic's passengers' ages and calculate the MSE.**
