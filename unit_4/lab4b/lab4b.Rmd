...
- **(12) Add this line to a scatterplot by filling in the blanks below.**
...
- **(15) Compare the MSE of the linear model you fitted using `add_line()` to the MSE of the linear model obtained with `lm()`. Which linear model performed better?**
