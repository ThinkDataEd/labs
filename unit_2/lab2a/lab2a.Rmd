...
- Do introverts and extroverts in your class differ in their color scores? 
    ...
    - **(20) Then, write a few sentences that address this statistical question and considers the _shape_, _center_ and _spread_ of the distributions of the graphs you create.**