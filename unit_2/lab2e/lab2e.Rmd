...
- **(16) Write and run code creating a `histogram` of the `difference`s in our `shuffled_outcomes` data. Based on your plot, answer the following:**
...
- **(22) Does `gender` play a role in whether or not a character will survive in a slasher film?**
    - **(23) Why or why not?**