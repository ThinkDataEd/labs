...
- <span class="blue">Ten simulations is not enough. Use the code above and perform 2000 shuffles. `Assign` your 2000 shuffles the same name `shuffled_outcomes`. Use `set.seed(1)`. </span>
...
- <span class="blue">Carry out another 2000 simulations but this time shuffle the `gender` variable instead of the `survival` variable. </span>
    - Include the code `set.seed(1)` before your 2000 simulations to make your answer reproducible.
