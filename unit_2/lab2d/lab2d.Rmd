...
- **(14) Write and run code performing 2000 simulations of sampling 2 songs from a playlist of 30 `"rap"`, 23 `"country"` and 47 `"rock"` songs. You might consider running `set.seed` so that your results can be reproduced:**
...
- <span class="blue">Using what you've learned in the previous two labs, answer the following question by performing two computer simulations with 2000 repetitions a piece:</span>
...
- For each simulation:
    - <span class="blue">Create a `histogram` for the number of _rap_ songs that occurred for each of the 2000 repetitions.</span>
