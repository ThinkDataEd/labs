...
[https://ids-labs.idsucla.org/extras/webdata/mountains.html](https://ids-labs.idsucla.org/extras/webdata/mountains.html)

- **(1) Briefly describe what the data on the website is about.**
    - **(2) Then write down 3 questions you'd be interested in answering by analyzing this data.**
