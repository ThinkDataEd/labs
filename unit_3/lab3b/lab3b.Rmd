...
- **(6) Write and run code using the `lungs` data to create an `xyplot` of `age` and `lung_cap`.**
    - **(7) Interpret the plot and describe why the relationship between the two variables makes sense.**

    
## Smoking and lung capacity

- **(8) Write and run code making a plot that can be used to answer the statistical investigative question:**

_Do people who smoke tend to have lower lung capacity than those who do not smoke?_

- **(9) Use your plot to answer the question**.
    - **(10) Were you surprised by the answer? Why?**
    - **(11) Can you suggest a possible confounding factor that might be affecting the result?**


## Let's compare

- **(12) Write and run code creating three subsets of the data:**
    - One that includes _only_ 13-year-olds ...
    - One that includes _only_ 15-year-olds ...
    - and one that includes _only_ 17-year-olds.
- **(13) Write and run code making a plot that compares the lung capacity of smokers and non-smokers for each subset.**
- **(14) How does the relationship between smoking and lung capacity change as we increase the age from 13 to 15 to 17?**


## Sum it up!

- **(15) Does smoking affect lung capacity? If so, how?**
