...
- To use _bootstrapped_ samples to create _confidence intervals_, we need to create many _bootstrapped_ samples.
    ...
    - In this lab, we'll `do()` 2000 _bootstrapped_ samples.
- To make `do()`-ing 2000 _bootstraps_ easier, we'll code our 3-step bootstrap method into a function.
...
- **(10) Once your function is created, fill in the blanks to create 2000 _bootstrapped_ sample means:**
