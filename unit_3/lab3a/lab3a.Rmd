...
- **(1) Write down two statistical questions that will help you answer the _research question_ from the previous slide.**
...
- <span class="blue">Create appropriate plots to answer your statistical questions.</span>

- <span class="blue">Calculate appropriate numerical summaries to answer your statistical questions.</span>
